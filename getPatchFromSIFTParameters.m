...
% position is a 2d vector, scale and orient are scalars;
%   These are extracted from the sift feature/keypoint descriptor f of length 4 by
%    positions = f(1:2,:)';  scales = f(3,:)'; orients = f(4,:)';
%
