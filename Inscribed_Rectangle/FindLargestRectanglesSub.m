function [C, H, W, r, c] = FindLargestRectanglesSub(I, crit, minSize)
...
%         r, c upper-left corner of the largest rectangle
...
hwaitbar = waitbar_start('FindLargestRectanglesSub');
