...
toc
tic
pixels3 = mesh_textured_2d_impl3(vertices, texture_vertices, triangles, texture, output_size);
toc

imshow_in_figure(pixels3, 'pixels, target triangles via triplot')
hold on
