...
assert(isdir(['Cameras/' DecodeOptions.WhiteImageInfo.CamSerial]), ['unknown camera ' DecodeOptions.WhiteImageInfo.CamSerial]);
assert(isdir(['Cameras/' DesiredCam.CamSerial]));
